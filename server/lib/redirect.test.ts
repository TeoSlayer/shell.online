...
describe("isValidRedirectUri", () => {
  it("accepts loopback callbacks on an unprivileged port", () => {
  ...
  it("rejects any host that is not loopback", () => {
  ...
  it("requires exactly the /callback path", () => {
  ...
  it("rejects embedded query, fragment or credentials", () => {
...
describe("buildRedirect", () => {
  it("appends code and state as query parameters", () => {
