...
- Expand the landing page with eight practical terminal-sharing use cases, clearer search metadata, visible crawlable fallback copy, and stricter no-index handling outside the canonical homepage.
