...
function frameDirection(opcode: number): number {
  if ([0x01, 0x03, 0x05, 0x07, 0x08, 0x0b, 0x0d].includes(opcode)) return DIRECTION_HOST_TO_VIEWER;
  if ([0x02, 0x04, 0x06, 0x09, 0x0a, 0x0c].includes(opcode)) return DIRECTION_VIEWER_TO_HOST;
