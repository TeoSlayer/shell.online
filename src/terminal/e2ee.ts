/*
 * Vendored verbatim from shell.online: web/e2ee.ts
 *
 * The browser half of the end-to-end encryption the CLI performs. Copied
 * rather than reimplemented so a bug fixed upstream is not left unfixed here,
 * and checked by `npm run check:protocol`. Do not edit here.
 */
