/*
 * Vendored from server/lib/mentions.ts so the browser highlights exactly the
 * mentions the service notified, and `npm run check:protocol` fails if the two
 * drift apart. Do not edit here.
 */
