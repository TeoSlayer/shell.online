...
The latest published CLI release is **v0.23.3**. `main` also contains newer app
...
```sh
git clone --depth 1 --branch v0.23.3 https://github.com/TeoSlayer/shell.online.git
cd shell.online
go build -buildvcs=false -trimpath -ldflags="-X main.version=0.23.3" -o shell ./cmd/shell
./shell --version
```
